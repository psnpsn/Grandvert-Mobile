...
public class ServiceReactionReponse {
    ...
    public ArrayList<Reaction_Reponse> parseListTaskJson(String json) {

        ArrayList<Reaction_Reponse> listReaction_Reponse = new ArrayList<>();
        ...
        try {
            ...
            */
            Map<String, Object> Reaction_Reponses = j.parseJSON(new CharArrayReader(json.toCharArray()));
                       
            
            /* Ici on récupère l'objet contenant notre liste dans une liste 
            d'objets json List<MAP<String,Object>> ou chaque Map est une tâche                
            */
            List<Map<String, Object>> list = (List<Map<String, Object>>) Reaction_Reponses.get("root");
        ...
        */
        System.out.println(listReaction_Reponse);
        return listReaction_Reponse;
    ...
    public ArrayList<Reaction_Reponse> getList(int id_reponse){       
        ...
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ServiceReactionReponse ser = new ServiceReactionReponse();
                listReaction_Reponses = ser.parseListTaskJson(new String(con.getResponseData()));
            }
        });
        NetworkManager.getInstance().addToQueueAndWait(con);
        return listReaction_Reponses;
    }
